...
import (
	...
	"go-wiki/app/utils"
	"go-wiki/install/controllers"
	"go-wiki/install/storage"
	"net/http"
	"os"
	"path/filepath"
)
...
func init() {
	...
	beego.AppConfig.Set("sys.name", "go-wiki-installer")
	...
	// session
	beego.BConfig.WebConfig.Session.SessionName = "gowikiinstallssid"
