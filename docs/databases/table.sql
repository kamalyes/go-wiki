...
-- 手动安装时首先需要创建数据库
-- CREATE DATABASE IF NOT EXISTS go_wiki DEFAULT CHARSET utf8;
...
-- 系统权限表
-- -------------------------------------------------------
DROP TABLE IF EXISTS `gw_privilege`;
CREATE TABLE `gw_privilege` (
...
-- 系统角色权限对应关系表
-- ------------------------------------------------------------------
DROP TABLE IF EXISTS `gw_role_privilege`;
CREATE TABLE `gw_role_privilege` (
...
-- 空间表
-- --------------------------------
DROP TABLE IF EXISTS `gw_space`;
CREATE TABLE `gw_space` (
...
-- 空间成员表
-- --------------------------------
DROP TABLE IF EXISTS `gw_space_user`;
CREATE TABLE `gw_space_user` (
...
-- 文档表
-- --------------------------------
DROP TABLE IF EXISTS `gw_document`;
...
-- 用户收藏表
-- --------------------------------
DROP TABLE IF EXISTS `gw_collection`;
CREATE TABLE `gw_collection` (
...
-- 用户关注表
-- --------------------------------
DROP TABLE IF EXISTS `gw_follow`;
CREATE TABLE `gw_follow` (
...
-- 文档日志表
-- --------------------------------
DROP TABLE IF EXISTS `gw_log_document`;
CREATE TABLE `gw_log_document` (
...
-- 邮件服务器表
-- --------------------------------
DROP TABLE IF EXISTS `gw_email`;
CREATE TABLE `gw_email` (
...
-- 统一登录认证表
-- --------------------------------
DROP TABLE IF EXISTS `gw_login_auth`;
CREATE TABLE `gw_login_auth` (
...
-- 系统联系人表
-- --------------------------------
DROP TABLE IF EXISTS `gw_contact`;
CREATE TABLE `gw_contact` (
...
-- 附件信息表
-- --------------------------------
DROP TABLE IF EXISTS `gw_attachment`;
